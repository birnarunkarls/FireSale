...
INSERT INTO item_bid (amount, notification, buyer_id_id, item_id_id) VALUES ('100', 'text_message', 1, 2);
INSERT INTO item_bid (amount, notification, buyer_id_id, item_id_id) VALUES ('1000', 'push_notification', 2, 3);
INSERT INTO item_bid (amount, notification, buyer_id_id, item_id_id) VALUES ('2500', 'text_message', 1, 3);
...
INSERT INTO item_item (name, description, condition, category, image, highest_bid, seller_id_id) VALUES ('Macbook', 'grey macbook pro 13', 'bad condition', 'electronics', 'IMG', 'SÆKJA', 2);
...
INSERT INTO item_item (name, description, condition, category, image, highest_bid, seller_id_id) VALUES ('Sweater', 'pink knit', 'medium', 'clothing', 'IMG', 'SÆKJA', 3);
...
INSERT INTO user_profile (bio, user_id, date_of_birth, phone_number, profile_picture) VALUES ('I am a very nice guy', 2, '12.09.2000', '888-7000', 'IMG');
INSERT INTO user_profile (bio, user_id, date_of_birth, phone_number, profile_picture) VALUES ('I am smart and beautiful', 3, '17.12.1990', '666-7000', 'IMG');


INSERT INTO user_user (username_id) VALUES (1);
INSERT INTO user_user (username_id) VALUES (2);
INSERT INTO user_user (username_id) VALUES (3);
